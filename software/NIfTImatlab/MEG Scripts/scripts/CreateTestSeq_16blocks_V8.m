...
for isub = 1:12
    ...
    encodingSeq([1 3 35 37 39 71 73 75 107 109 111 143 145 147 179 181 183 215 217 219 251 253 255 287 289 291 323 325 327 359 361 363 395 397 399 431 433 435 467 469 471 503 505 507 539 541 543 575],:)=[];
    
    NBorder1 = encodingSeq(cell2mat(encodingSeq(:,3))==2,1);
    
    NBorder2 = encodingSeq(cell2mat(encodingSeq(:,3))==6,1);
    
    NBsource = encodingSeq(cell2mat(encodingSeq(:,3))==4,1);
    
    NBencodingColor = encodingSeq(cell2mat(encodingSeq(:,3))==4,4);
    
    NBencodingColor2 = encodingSeq(cell2mat(encodingSeq(:,3))==4,4);
    
    
    Border1 = encodingSeq(cell2mat(encodingSeq(:,3))==5,1);
    
    Border2 = encodingSeq(cell2mat(encodingSeq(:,3))==3,1);
    
    Bsource = encodingSeq(cell2mat(encodingSeq(:,3))==1,1);
    
    BencodingColor = encodingSeq(cell2mat(encodingSeq(:,3))==5,4);
    
    BencodingColor2 = encodingSeq(cell2mat(encodingSeq(:,3))==3,4);
    ...
    NBtestList = [NBsource NBorder1 NBorder2 num2cell([ones(6,1); ones(6,1)*2; ones(6,1)*3; ones(6,1)*4; ones(6,1)*5; ones(6,1)*6; ones(6,1)*7; ones(6,1)*8; ones(6,1)*9; ones(6,1)*10; ones(6,1)*11; ones(6,1)*12; ones(6,1)*13; ones(6,1)*14; ones(6,1)*15; ones(6,1)*16]) repmat({'NB'},96,1) NBencodingColor NBencodingColor2 num2cell(NBtest_neighbors_lures_rand)];
    
    BtestList = [Bsource Border1 Border2 num2cell([ones(5,1); ones(5,1)*2; ones(5,1)*3; ones(5,1)*4; ones(5,1)*5; ones(5,1)*6; ones(5,1)*7; ones(5,1)*8; ones(5,1)*9; ones(5,1)*10; ones(5,1)*11; ones(5,1)*12; ones(5,1)*13; ones(5,1)*14; ones(5,1)*15; ones(5,1)*16]) repmat({'B'},80,1) BencodingColor BencodingColor2 num2cell(Btest_neighbors_lures_rand)];
...
%     end
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList1(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList1(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList1(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList2(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList2(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList2(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList3(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList3(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList3(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList4(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList4(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList4(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList5(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList5(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList5(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList6(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList6(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList6(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList7(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList7(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList7(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList8(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList8(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList8(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList9(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList9(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList9(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList10(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList10(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList10(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList11(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList11(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList11(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList12(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList12(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList12(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList13(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList13(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList13(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList14(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList14(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList14(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList15(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList15(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList15(pairs(1),5),'B')];
    ...
    while 1
        ...
        uniqueStim = unique(cell2mat(testList16(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList16(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList16(pairs(1),5),'B')];
...
%     end
    ...
    uniqueStim = unique(cell2mat(testList11a(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList11a(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList11a(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList21(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList21(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList21(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList31(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList31(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList31(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList41(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList41(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList41(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList51(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList51(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList51(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList61(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList61(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList61(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList71(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList71(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList71(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList81(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList81(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList81(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList91(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList91(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList91(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList101(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList101(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList101(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList111(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList111(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList111(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList121(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList121(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList121(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList131(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList131(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList131(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList141(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList141(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList141(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList151(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList151(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList151(pairs(1),5),'B')];
    ...
    uniqueStim = unique(cell2mat(testList161(:,6)));
        Bfirst = [];
        
        for icb = 1:length(uniqueStim)
            
            pairs = find(cell2mat(testList161(:,6))==uniqueStim(icb));
            
            if length(pairs)==2
                
                Bfirst = [Bfirst; strcmp(testList161(pairs(1),5),'B')];
    ...
    for iColorCB = 1:4
        ...
        for itrial = 1:44
            ...
            colorPos = mod(find(tmp{itrial,7}==currentColorOrder),6);
            if colorPos==0
                colorPos=6;
            end
            ...
            if strcmp(tmp{itrial,5},'B')
                ...
                BcontextColor(length(BcontextColor)+1) =  tmp{itrial,7};
    ...
    for iTest = 1:16
        ...
        for iLure = 1:11
            ...
            if strcmp(tmp{iLure,5},'B')
                ...
                tmp{iLure,9}= BcolorLurePositionVec(B_counter);
                tmp{iLure,10}= BLureColorVec(B_counter);
            ...
            if strcmp(tmp{iLure,5},'NB')
                ...
                tmp{iLure,9}= NBcolorLurePositionVec(NB_counter);
                tmp{iLure,10}= NBLureColorVec(NB_counter);
    ...
    testSeq_tmp1 = testSeq(:,8);
    testSeq_tmp2 = testSeq(:,9);
    testSeq_tmp3 = testSeq(:,10);
    
    testSeq(:,8)=testSeq_tmp3;
    testSeq(:,10)=testSeq_tmp2;
    testSeq(:,9)=testSeq_tmp1;
