function[all_data,uncat_data,meta_runs_condensed,condensed_regs_all]= psa_prepdata(subNum,P)
...
% create a subject ID
%if S.subjNum<10   
%    S.subj_id=strcat(S.expName, '_sub0', num2str(S.subjNum));   % assumes your subject folder has a name of the form "expName_sub01")
%else
%    S.subj_id=strcat(S.expName, '_sub', num2str(S.subjNum));
%end
