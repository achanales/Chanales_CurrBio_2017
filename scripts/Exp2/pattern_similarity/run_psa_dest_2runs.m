function[dataMat,dataMat2]= run_psa_dest_2runs(all_data,meta_runs_condensed,condensed_regs_all,P)
...
for i = 1:length(groups)
    ...
    sdestCorr = mean(corr_data(find(sdest)));
    ...
    dataMat(1,colstart:colstart+3) = [sameCorr sdestCorr overlapCorr diffCorr];
    dataMat(2,colstart:colstart+3) = [1 2 3 4]; %this row identifies the comparision 1 == same 2= sdest 3= overlap 4 = diff
    dataMat(3,colstart:colstart+3) = [i i i i]; %this row identifies the half
